...
origin_by_ethnicity = {
    ...
    # ==================== GENASI ====================
    "Air Genasi":     {40: 40, 5: 15, 43: 10, 59: 10, 47: 10, 0: 15},
    "Earth Genasi":   {37: 35, 33: 25, 40: 15, 45: 10, 0: 15},
    "Fire Genasi":    {1: 45, 40: 20, 43: 10, 59: 10, 0: 15},
    "Water Genasi":   {22: 30, 69: 20, 5: 15, 10: 10, 58: 10, 0: 15},

    # ==================== HALFLINGS ====================
    "Lightfoot Halfling":   {35: 40, 46: 25, 5: 15, 6: 10, 0: 10},
    "Strongheart Halfling": {35: 45, 46: 20, 7: 15, 5: 10, 0: 10},

    # ==================== AUTRES ETHNIES HUMAINES ====================
    "Nar":        {15: 35, 16: 25, 18: 15, 36: 10, 44: 5, 0: 10},
    "Reghedman":  {21: 55, 41: 25, 37: 10, 0: 10},

    # === Nouvelles entrées pour réduire le fallback "région aléatoire" ===
    "Shaaran":        {47: 45, 1: 15, 48: 12, 49: 10, 0: 18},
    "Forest Gnome":   {27: 35, 28: 25, 29: 15, 26: 10, 0: 15},
    "Rock Gnome":     {30: 30, 5: 20, 31: 15, 45: 10, 0: 25},
    "Raumviran":      {14: 35, 17: 25, 44: 15, 16: 10, 0: 15},
    "Tashalan":       {66: 40, 24: 20, 64: 15, 47: 10, 0: 15},
    "Ulutiun":        {23: 45, 57: 25, 21: 10, 0: 20},

    # === Dernières 8 pour descendre à 0% de fallback Origins ===
    "Arctic Dwarf":      {57: 45, 21: 25, 23: 15, 0: 15},
    "Ghostwise Halfling": {85: 40, 47: 25, 29: 15, 0: 20},
    "Half-Orc Mountain": {37: 40, 41: 25, 42: 15, 0: 20},
    "Imaskari":          {12: 30, 13: 25, 51: 20, 1: 10, 0: 15},
    "Lantanna":          {30: 70, 5: 10, 0: 20},
    "Talfir":            {3: 35, 53: 30, 49: 15, 0: 20},
    "Urdunnir":          {33: 50, 39: 30, 0: 20},
    "Wild Dwarf":        {24: 45, 105: 30, 47: 10, 0: 15},
}
