...
ethnicity_data = {
    ...
    "Fallen Aasimar":   {"idx": 51, "r": "Autre", "w": 0, "b": 0, "bal": 1, "quickness": 1, "coo": 1, "pre": 1, "end": 1, "reg": 2, "vig": 1, "bea": 1, "spec": "Lumière sombre", "cp": 1.8},
    "Goliath":          {"idx": 52, "r": "Autre", "w": 8, "b": 0, "bal": 1, "quickness": 0, "coo": -1, "pre": -1, "end": 3, "reg": 4, "vig": 0, "bea": -2, "spec": "Réduction de dégâts", "cp": 1.5},
    "Genasi Terre":     {"idx": 53, "r": "Autre", "w": 3, "b": 3, "bal": 0, "quickness": -1, "coo": 0, "pre": 1, "end": 3, "reg": 2, "vig": 1, "bea": -1, "spec": "Affinité terre", "cp": 1.2},
    "Genasi Feu":       {"idx": 54, "r": "Autre", "w": 1, "b": 2, "bal": 1, "quickness": 2, "coo": 1, "pre": 1, "end": 2, "reg": 1, "vig": 2, "bea": 1, "spec": "Affinité feu", "cp": 1.5},
    "Genasi Air":       {"idx": 55, "r": "Autre", "w": -2, "b": 0, "bal": 2, "quickness": 4, "coo": 2, "pre": 2, "end": 1, "reg": 0, "vig": 3, "bea": 2, "spec": "Affinité air", "cp": 1.8},
    "Genasi Eau":       {"idx": 56, "r": "Autre", "w": 1, "b": 1, "bal": 1, "quickness": 1, "coo": 1, "pre": 1, "end": 3, "reg": 3, "vig": 1, "bea": 1, "spec": "Affinité eau", "cp": 1.3},
    "Firbolg":          {"idx": 57, "r": "Autre", "w": 6, "b": 4, "bal": 1, "quickness": 0, "coo": 0, "pre": 0, "end": 3, "reg": 3, "vig": 1, "bea": 0, "spec": "Magie druidique innée", "cp": 1.4},
    "Tabaxi":           {"idx": 58, "r": "Autre", "w": -4, "b": 0, "bal": 3, "quickness": 4, "coo": 2, "pre": 2, "end": 1, "reg": 1, "vig": 2, "bea": 1, "spec": "Agilité féline", "cp": 1.3},
    "Forgelier":        {"idx": 59, "r": "Autre", "w": 7, "b": 8, "bal": 2, "quickness": 0, "coo": 0, "pre": 1, "end": 4, "reg": 3, "vig": 1, "bea": -2, "spec": "Corps construct", "cp": 1.6},
    "Aarakocra":        {"idx": 60, "r": "Autre", "w": -6, "b": 0, "bal": 2, "quickness": 4, "coo": 1, "pre": 1, "end": 1, "reg": 0, "vig": 3, "bea": 2, "spec": "Vol naturel très puissant", "cp": 3.0},
    "Abbalaya":         {"idx": 61, "r": "Autre", "w": -1, "b": 1, "bal": 1, "quickness": 2, "coo": 2, "pre": 2, "end": 2, "reg": 1, "vig": 2, "bea": 1, "spec": "Aucun", "cp": 0.8},
    "Alaghi":           {"idx": 62, "r": "Autre", "w": 6, "b": 4, "bal": 0, "quickness": 1, "coo": -1, "pre": -1, "end": 3, "reg": 2, "vig": 0, "bea": -2, "spec": "Force brute", "cp": 1.2},
    "Aranea":           {"idx": 63, "r": "Autre", "w": -4, "b": -2, "bal": 2, "quickness": 2, "coo": 3, "pre": 3, "end": 1, "reg": 0, "vig": 2, "bea": 2, "spec": "Métamorphose araignée", "cp": 1.5},
    "Bullywug":         {"idx": 64, "r": "Autre", "w": -6, "b": 0, "bal": 2, "quickness": 2, "coo": -1, "pre": -1, "end": 2, "reg": 2, "vig": 0, "bea": -2, "spec": "Saut puissant", "cp": 0.8},
    ...
    "Githzerai":        {"idx": 72, "r": "Autre", "w": -1, "b": 0, "bal": 2, "quickness": 1, "coo": 1, "pre": 1, "end": 1, "reg": 1, "vig": 2, "bea": 0, "spec": "Discipline mentale", "cp": 1.2},
    ...
    "Harssaf":          {"idx": 80, "r": "Autre", "w": 3, "b": 1, "bal": 2, "quickness": 2, "coo": 1, "pre": 1, "end": 2, "reg": 3, "vig": 2, "bea": 0, "spec": "Adaptation désert", "cp": 0.9},
    "Hobgoblin":        {"idx": 81, "r": "Autre", "w": 3, "b": 2, "bal": 0, "quickness": 1, "coo": 0, "pre": 0, "end": 2, "reg": 2, "vig": 1, "bea": -1, "spec": "Discipline militaire", "cp": 0.5},
    "Ixzan":            {"idx": 82, "r": "Autre", "w": -5, "b": 2, "bal": 2, "quickness": 1, "coo": 2, "pre": 2, "end": 1, "reg": 1, "vig": 2, "bea": -1, "spec": "Aucun", "cp": 1.0},
    "Juna":             {"idx": 83, "r": "Autre", "w": 0, "b": 1, "bal": 1, "quickness": 2, "coo": 2, "pre": 2, "end": 2, "reg": 1, "vig": 2, "bea": 2, "spec": "Aucun", "cp": 0.8},
    "Kappa":            {"idx": 84, "r": "Autre", "w": 2, "b": 3, "bal": 1, "quickness": 1, "coo": 1, "pre": 1, "end": 3, "reg": 3, "vig": 1, "bea": -1, "spec": "Carapace", "cp": 1.2},
    "Khala":            {"idx": 85, "r": "Autre", "w": 3, "b": 2, "bal": 1, "quickness": 2, "coo": 1, "pre": 1, "end": 3, "reg": 2, "vig": 1, "bea": 0, "spec": "Aucun", "cp": 1.0},
    "Killoren":         {"idx": 86, "r": "Autre", "w": -1, "b": 1, "bal": 2, "quickness": 2, "coo": 2, "pre": 2, "end": 2, "reg": 2, "vig": 2, "bea": 3, "spec": "Affinité nature", "cp": 1.5},
    ...
    "Merfolk":          {"idx": 95, "r": "Autre", "w": 0, "b": 0, "bal": 1, "quickness": 2, "coo": 1, "pre": 1, "end": 2, "reg": 2, "vig": 1, "bea": 2, "spec": "Respiration aquatique", "cp": 1.0},
    "Minotaur":         {"idx": 96, "r": "Autre", "w": 8, "b": 6, "bal": 0, "quickness": 1, "coo": 0, "pre": -1, "end": 4, "reg": 3, "vig": 0, "bea": -2, "spec": "Charge puissante", "cp": 1.5},
    ...
    "Para-genasi":      {"idx": 104,"r": "Autre", "w": 1, "b": 1, "bal": 1, "quickness": 1, "coo": 1, "pre": 1, "end": 2, "reg": 1, "vig": 1, "bea": 1, "spec": "Affinité élémentaire", "cp": 1.2},
    "Pterafolk":        {"idx": 105,"r": "Autre", "w": -2, "b": 2, "bal": 2, "quickness": 3, "coo": 1, "pre": 1, "end": 2, "reg": 1, "vig": 2, "bea": 0, "spec": "Vol plané", "cp": 2.0},
    "Raptoran":         {"idx": 106,"r": "Autre", "w": -3, "b": 1, "bal": 2, "quickness": 3, "coo": 2, "pre": 2, "end": 2, "reg": 1, "vig": 2, "bea": 2, "spec": "Vol naturel", "cp": 3.0},
    "Razorclaw Shifter": {"idx": 107,"r": "Autre", "w": 1, "b": 2, "bal": 1, "quickness": 2, "coo": 2, "pre": 1, "end": 2, "reg": 1, "vig": 1, "bea": 0, "spec": "Transformation bestiale", "cp": 1.2},
    "Sarrukh":          {"idx": 108,"r": "Autre", "w": 5, "b": 4, "bal": 0, "quickness": 1, "coo": 1, "pre": 2, "end": 3, "reg": 3, "vig": 2, "bea": -2, "spec": "Créateur de races", "cp": 2.5},
    "Saru":             {"idx": 109,"r": "Autre", "w": 3, "b": 3, "bal": 1, "quickness": 2, "coo": 1, "pre": 1, "end": 3, "reg": 2, "vig": 1, "bea": -1, "spec": "Aucun", "cp": 0.8},
    "Satyr":            {"idx": 110,"r": "Autre", "w": 1, "b": 1, "bal": 2, "quickness": 3, "coo": 2, "pre": 2, "end": 2, "reg": 1, "vig": 2, "bea": 3, "spec": "Charme musical", "cp": 1.5},
    "Saurial":          {"idx": 111,"r": "Autre", "w": 2, "b": 2, "bal": 1, "quickness": 1, "coo": 1, "pre": 1, "end": 3, "reg": 3, "vig": 1, "bea": 0, "spec": "Aucun", "cp": 0.8},
    ...
    "Yuan-ti Pureblood":{"idx": 121,"r": "Autre", "w": 0, "b": 1, "bal": 1, "quickness": 1, "coo": 2, "pre": 2, "end": 2, "reg": 2, "vig": 2, "bea": 2, "spec": "Résistance poison", "cp": 1.5},
    "Yurian":           {"idx": 122,"r": "Autre", "w": 3, "b": 3, "bal": 0, "quickness": 1, "coo": 0, "pre": 0, "end": 3, "reg": 2, "vig": 0, "bea": -2, "spec": "Aucun", "cp": 0.8},
    "Tiefling":         {"idx": 134,"r": "Autre", "w": -1, "b": 1, "bal": 0, "quickness": 1, "coo": 1, "pre": 1, "end": 1, "reg": 0, "vig": 1, "bea": 1, "spec": "Magie infernale", "cp": 1.2},
    "Kenku":            {"idx": 135,"r": "Autre", "w": -8, "b": -1, "bal": 2, "quickness": 2, "coo": 2, "pre": 2, "end": 0, "reg": 0, "vig": 2, "bea": -1, "spec": "Mimétisme vocal", "cp": 0.8},
